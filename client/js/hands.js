...
righthand.quaternion.copy(camera.quaternion); // apply camera's quaternion
righthand.position.setFromMatrixPosition(emitter.matrixWorld); // start position -
...
lefthand.position.setFromMatrixPosition(emitter.matrixWorld); // start position -
